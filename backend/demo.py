...
if __name__ == "__main__":
    ...
    print(predict(input_text, ext_model, cls_model, tokenizer, ext_id2label, cls_id2label, max_seq_len=max_seq_len))

    # 读取Excel文件内容进行批量情感分析
    df = pd.read_excel('./resources/测试数据.xlsx', index_col=None)
